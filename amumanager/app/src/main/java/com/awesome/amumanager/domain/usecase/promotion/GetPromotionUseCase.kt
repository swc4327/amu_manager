...
class GetPromotionUseCase @Inject constructor(private val repository: PromotionRepository) {
    operator fun invoke(promotions: MutableLiveData<ArrayList<Promotion>>,
                        storeId: String,
                        lastId: String) {
        repository.getPromotion(promotions, storeId, lastId)
    }
}