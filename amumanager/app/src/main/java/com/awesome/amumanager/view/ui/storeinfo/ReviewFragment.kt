...
import com.awesome.amumanager.view.ui.ReviewDetailActivity
import com.awesome.amumanager.view.ui.adapter.MenuListAdapter
import com.awesome.amumanager.view.ui.adapter.ReviewListAdapter
import com.awesome.amumanager.viewmodel.MenuViewModel
import com.awesome.amumanager.viewmodel.MenuViewModelFactory
import com.awesome.amumanager.viewmodel.ReviewViewModel
import com.awesome.amumanager.viewmodel.ReviewViewModelFactory
...
class ReviewFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        reviewListAdapter = ReviewListAdapter(requireContext(), reviewViewModel.reviewLists.value!!)

        reviewViewModel.reviewLists.observe(viewLifecycleOwner, Observer<ArrayList<ReviewList>> {
            println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAABBB")
