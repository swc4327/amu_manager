...
import com.awesome.amumanager.domain.model.Constants.STORE_INFO_SETTING_ACTIVITY
...
class StoreInfoActivity : BaseActivity() {
    ...
    private fun initListener() {
        ...
        setting.setOnClickListener {
            store?.let { store ->
                StoreInfoSettingActivity.startActivityForResult(
                    this,
                    store,
                    STORE_INFO_SETTING_ACTIVITY
                )
            }
            //가게삭제, 영업시작, 영업종료
        }
