...
import com.awesome.amumanager.data.api.service.ReviewApi
...
class AmuManagerReviewDataSource @Inject constructor(
    ...
    override fun getReviewList(
        ...
        reviewApi.getReviewList(storeId, lastId)
    ...
    override fun reviewFiltering(review: Review, client: Client, status: MutableLiveData<Int>) {
        reviewApi.filterReview(review!!.id.toString(), review!!.storeId)
